...
export default function SectionOne() {
  return (
    <>
      <div>
        <h4 className="my-6 text-base font-semibold">
        ...
        <p className="text-sm mb-3">
          (b) "Customer" means the person or corporation placing an order for
        ...
        <p className="text-sm mb-3">
          (d) if the Customer comprises more than one person, each of those
          person’s liability is joint and several;
        </p>

        <p className="text-sm mb-3">
          (e) references to a party or a person includes any form of entity and
      ...
      <div>
        <h4 className="my-6 text-base font-semibold">General</h4>
        ...
        <p className="text-sm mb-3">
          ...
          constitute an acceptance of the terms as varied. Once a Customer order
          has been placed and accepted by Shop, the Customer agrees that the
          Customer has no right to cancel or vary the order at any time, unless
          agreed upon in writing by both parties.
        </p>
      </div>

      <div>
        <h4 className="my-6 text-base font-semibold">Quotations</h4>
      ...
      <div>
        <h4 className="my-6 text-base font-semibold">Prices / Taxes</h4>
        ...
        <p className="text-sm mb-3">
          ...
          the total quantity purchased by the Customer. Prices include GST, but
          do not include any other tax or duty, which is in addition to the
          price and is to be paid by the Customer at the time of payment for the
          Products.
        </p>
      </div>

      <div>
        <h4 className="my-6 text-base font-semibold">Terms of Payment</h4>

        <p className="text-sm mb-5">
          Credit Card Payments may attract a surcharge, and Shop will inform the
          Customer if this is to be the case before processing the transaction.
        </p>

        <p className="text-sm mb-5">
          Unless otherwise agreed in writing by Shop, where Shop has not agreed
          in writing to provide commercial credit to the Customer, the total
          purchase price for Products supplied will be due for payment in cash
          prior to delivery.
        </p>
      ...
      <div>
        <h4 className="my-6 text-base font-semibold">Credit Accounts</h4>
      ...
      <div>
        <h4 className="my-6 text-base font-semibold">Change of Ownership</h4>
        ...
        <p className="text-sm mb-3">
          ...
          that there is a change in ownership of the Customer, whether total or
          partial, the Customer must immediately provide written notice to Shop
          informing Shop of these changes. Until Shop receives written notice
          from the Customer of a change in ownership, the Customer (including
          where it is a company or trustee, each of the Directors thereof) holds
          Shop indemnified against any and all losses, unpaid accounts,
          interest, damages, costs, charges, fees and expenses incurred or
          suffered by Shop in trading with any person, company (including the
          same company but with a different shareholder or shareholders) or
          other entity (including a trust) which may have purchased the
          Customer's business or any interest in the Customer's business or any
          of the shares in the Customer and used the Customer's previously
          approved account for trading.
        </p>

        <p className="text-sm mb-3">
          Where a Customer has been authorised by Shop to make payments through
          Credit Card Direct Debit, the Customer must provide notice in writing
          at least five (5) days prior to any change in ownership of the
          business to allow Shop sufficient time to contact the new owner to
          obtain and confirm new Credit Card information if applicable.
        </p>
      </div>
      ...
      <div>
        <h4 className="my-6 text-base font-semibold">Delivery</h4>
        ...
        <p className="text-sm mb-3">
          ...
          deliveries. In the event that Shop incurs additional costs for meeting
          special (i.e. Tasmania / Northern Territory Deliveries) or urgent
          delivery arrangements, these additional costs may be charged to the
          Customer and may include the cost of airfreight where it is not the
          normal method of delivery. The Customer agrees to accept delivery of
          the Products sold at any time during normal business hours.
        </p>

        <p className="text-sm mb-3">
          Shop will not be liable for any loss or damage resulting from any late
          delivery of the Products and late delivery will not entitle the
